...
2. Uno Deck
   ethan@ethan-XPS-15-7590:~/cse428/Lab3/Lab3$ ./lab3 GoFish Uno p0 p1
   PLAYER: p0
   threered draw twoyellow sevenblue fourblue draw twored skipyellow draw fourblack
   Books:
   PLAYER: p1
   blankblack twogreen fourgreen eightgreen reversered eightblue sixblue
   Books:
   TURN OF player: p0
   What card rank and what player number? enter as rank number SPACE player number
   four 1
   PLAYER: p0
   threered draw twoyellow sevenblue fourblue draw twored skipyellow draw fourblack fourgreen
   Books:
   PLAYER: p1
   blankblack twogreen eightgreen reversered eightblue sixblue
   Books:
   TURN OF player: p0
   What card rank and what player number? enter as rank number SPACE player number
   three 1
   Go fish
   PLAYER: p0
   threered draw twoyellow sevenblue fourblue draw twored skipyellow draw fourblack fourgreen fouryellow
   Books:
   PLAYER: p1
   blankblack twogreen eightgreen reversered eightblue sixblue
   Books:
...
3. Pinochle Deck
   ethan@ethan-XPS-15-7590:~/cse428/Lab3/Lab3$ ./lab3 GoFish Pinochle p0 p1
   PLAYER: p0
   9 D 9 H J H J C J D K C K S  
   Books:
   PLAYER: p1
   9 H A H 9 D Q C K D J S 10 H  
   Books:
   TURN OF player: p0
   What card rank and what player number? enter as rank number SPACE player number
   nine 1
   PLAYER: p0
   J H J C J D K C K S  
   Books: 9 D 9 H 9 H 9 D

PLAYER: p1
A H Q C K D J S 10 H  
Books:
TURN OF player: p0
What card rank and what player number? enter as rank number SPACE player number
jack 1
